!(function (e, a) {
  ...
  s("H", ["HH", 2], 0, "hour"),
    ...
    s("hmmss", 0, 0, function () {
      return (
        "" + ua.apply(this) + de(this.minutes(), 2) + de(this.seconds(), 2)
      );
    }),
    s("Hmm", 0, 0, function () {
  ...
  function Wa(e) {
    ...
    s
      ? ((a = Oa(s[4], s[3], s[2], s[5], s[6], s[7])),
        (function (e, a, t) {
          if (!e || ra.indexOf(e) === new Date(a[0], a[1], a[2]).getDay())
            return 1;
          ...
          (e._tzm =
            ...
            a
              ...
              : t
              ? 0
              : 60 * (((a = parseInt(s, 10)) - (t = a % 100)) / 100) + t)),
  ...
  function Ca(e) {
    ...
    (this._isValid = (function (e) {
      var a,
        ...
        n = Ra.length;
      for (a in e)
        if (l(e, a) && (-1 === T.call(Ra, a) || (null != e[a] && isNaN(e[a]))))
          return !1;
      for (t = 0; t < n; ++t)
        if (e[Ra[t]]) {
          if (s) return !1;
        ...
        : "object" == typeof s &&
          ...
          ((a = (function (e, a) {
            ...
            (a = Ba(a, e)),
              e.isBefore(a)
                ? (t = at(e, a))
                : (((t = at(a, e)).milliseconds = -t.milliseconds),
                  (t.months = -t.months));
            return t;
          })(w(s.from), w(s.to))),
          ((s = {}).ms = a.milliseconds),
        ...
        switch (((t = this._isUTC ? lt : ut), e)) {
          ...
          case "hour":
            (a = this._d.valueOf()),
              (a +=
                36e5 -
                mt(a + (this._isUTC ? 0 : 6e4 * this.utcOffset()), 36e5) -
                1);
            break;
          case "minute":
    ...
    (u.startOf = function (e) {
      ...
      if (void 0 !== (e = d(e)) && "millisecond" !== e && this.isValid()) {
        switch (((t = this._isUTC ? lt : ut), e)) {
          ...
          case "hour":
            (a = this._d.valueOf()),
              (a -= mt(a + (this._isUTC ? 0 : 6e4 * this.utcOffset()), 36e5));
            break;
          case "minute":
  ...
  (M.calendar = function (e, a, t) {
    ...
    (M.months = function (e, a) {
      return e
        ? (F(this._months)
            ? this._months
            : this._months[
                (this._months.isFormat || Ge).test(a) ? "format" : "standalone"
              ])[e.month()]
        : F(this._months)
        ? this._months
    ...
    (M.monthsShort = function (e, a) {
      return e
        ? (F(this._monthsShort)
            ? this._monthsShort
            : this._monthsShort[Ge.test(a) ? "format" : "standalone"])[
            e.month()
          ]
        : F(this._monthsShort)
        ? this._monthsShort
    ...
    Rt =
      ...
      (v.as = function (e) {
        ...
        if ("month" === (e = d(e)) || "quarter" === e || "year" === e)
          switch (
            ((a = this._days + s / 864e5), (t = this._months + bt(a)), e)
          ) {
            case "month":
              return t;
            case "quarter":
  ...
  var us = "ene._feb._mar._abr._may._jun._jul._ago._sep._oct._nov._dic.".split(
      "_"
    ),
